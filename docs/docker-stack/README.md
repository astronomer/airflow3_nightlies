...
You can find the following images there (Assuming Airflow version `3.0.0.dev20250321`):
...
* `apache/airflow:3.0.0.dev20250321` - the versioned Airflow image with default Python version (3.12 currently)
* `apache/airflow:3.0.0.dev20250321-pythonX.Y` - the versioned Airflow image with specific Python version
...
* `apache/airflow:slim-3.0.0.dev20250321`           - the versioned Airflow image with default Python version (3.12 currently)
* `apache/airflow:slim-3.0.0.dev20250321-pythonX.Y` - the versioned Airflow image with specific Python version
