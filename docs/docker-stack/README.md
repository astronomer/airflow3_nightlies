...
You can find the following images there (Assuming Airflow version `3.0.0.dev202503310001`):
...
* `apache/airflow:3.0.0.dev202503310001` - the versioned Airflow image with default Python version (3.12 currently)
* `apache/airflow:3.0.0.dev202503310001-pythonX.Y` - the versioned Airflow image with specific Python version
...
* `apache/airflow:slim-3.0.0.dev202503310001`           - the versioned Airflow image with default Python version (3.12 currently)
* `apache/airflow:slim-3.0.0.dev202503310001-pythonX.Y` - the versioned Airflow image with specific Python version
